...
class MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 180, 1861, 721))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.graph_Layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.graph_Layout.setContentsMargins(0, 0, 0, 0)
        self.graph_Layout.setObjectName("graph_Layout")
        self.layoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget_2.setGeometry(QtCore.QRect(600, 10, 641, 131))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.gas_menu_lay = QtWidgets.QVBoxLayout(self.layoutWidget_2)
        self.gas_menu_lay.setContentsMargins(0, 0, 0, 0)
        self.gas_menu_lay.setObjectName("gas_menu_lay")
        self.label = QtWidgets.QLabel(self.layoutWidget_2)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.gas_menu_lay.addWidget(self.label)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.spinBoxMin = QtWidgets.QSpinBox(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBoxMax = QtWidgets.QSpinBox(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gas_menu_lay.addLayout(self.horizontalLayout_2)
        self.valueGas = QtWidgets.QLabel(self.layoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gas_menu_lay.addWidget(self.valueGas)
        self.SliderPower = QtWidgets.QSlider(self.layoutWidget_2)
        self.SliderPower.setMaximum(100)
        self.SliderPower.setOrientation(QtCore.Qt.Horizontal)
        self.SliderPower.setObjectName("SliderPower")
        self.gas_menu_lay.addWidget(self.SliderPower)
        self.layoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget_3.setGeometry(QtCore.QRect(210, 10, 381, 131))
        self.layoutWidget_3.setObjectName("layoutWidget_3")
        self.settings_lay = QtWidgets.QVBoxLayout(self.layoutWidget_3)
        self.settings_lay.setContentsMargins(0, 0, 0, 0)
        self.settings_lay.setSpacing(0)
        self.settings_lay.setObjectName("settings_lay")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.ButTarTraction = QtWidgets.QPushButton(self.layoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ButTarWeight = QtWidgets.QPushButton(self.layoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.ButCalibTraction = QtWidgets.QPushButton(self.layoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ButCalibWeight = QtWidgets.QPushButton(self.layoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ButCalib = QtWidgets.QPushButton(self.layoutWidget_3)
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(10, 10, 191, 61))
        self.layoutWidget_4.setObjectName("layoutWidget_4")
        self.menu_port_lay = QtWidgets.QVBoxLayout(self.layoutWidget_4)
        self.menu_port_lay.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.menu_port_lay.setContentsMargins(0, 0, 0, 0)
        self.menu_port_lay.setSpacing(0)
        self.menu_port_lay.setObjectName("menu_port_lay")
        self.MenuPorts_2 = QtWidgets.QHBoxLayout()
        self.MenuPorts_2.setSizeConstraint(QtWidgets.QLayout.SetFixedSize)
        self.MenuPorts_2.setContentsMargins(-1, 0, 0, 0)
        self.MenuPorts_2.setSpacing(6)
        self.MenuPorts_2.setObjectName("MenuPorts_2")
        self.ListPorts = QtWidgets.QComboBox(self.layoutWidget_4)
        ...
        self.MenuPorts_2.addWidget(self.ListPorts)
        self.ButOpenPort = QtWidgets.QPushButton(self.layoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.MenuPorts_2.addWidget(self.ButOpenPort)
        self.menu_port_lay.addLayout(self.MenuPorts_2)
        self.butRefresh = QtWidgets.QPushButton(self.layoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.menu_port_lay.addWidget(self.butRefresh)
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 80, 191, 62))
        self.layoutWidget.setObjectName("layoutWidget")
        self.LayAutoTest = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.LayAutoTest.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.LayAutoTest.setContentsMargins(0, 0, 0, 0)
