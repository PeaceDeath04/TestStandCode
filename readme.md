...
- Создать папку в которой будет хранится exe файл программы ( скачать его можно из папки dist)
- открыть , а далее настроить все необходимые параметры: шаг подачи газа , калибровочный вес, временные точки автотеста , отображаемые графики , минимальное допустимое значение газа и максимальное
